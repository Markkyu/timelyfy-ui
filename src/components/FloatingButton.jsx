...
const FloatingButton = ({
  ...
  return (
    <>
      <button onClick={onAddClick} className="group fixed top-1/2 -right-10 transform -translate-y-1/2 z-50 flex items-center bg-red-800 text-white px-2 py-2 rounded-full hover:bg-red-900 hover:cursor-pointer shadow-md">
      ...
      <button onClick={onHomeClick} className="group fixed top-4/10 -right-0 transform -translate-y-1/2 z-50 flex mr-2 border-4 border-red-800 items-center bg-white text-white px-2 py-2 rounded-full hover:bg-gray-50 hover:cursor-pointer shadow-md">
        <div className="absolute right-full mr-4 hidden group-hover:flex items-center">
          <div className="relative bg-white text-gray-800 text-sm font-semibold px-4 py-2 rounded-xl shadow-md">
            Upload CSV
            <div className="absolute top-1/2 -right-2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-b-8 border-l-8 border-transparent border-l-white" />
        ...
        <div className="flex content-center">
          <FileSpreadsheet color="maroon" size="30" />
        </div>
      </button>
